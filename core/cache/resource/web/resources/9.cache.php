<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1477827332,
    'editedby' => 1,
    'editedon' => 1477843577,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1477827300,
    'publishedby' => 1,
    ...
    <div class="mobile-menu__inner">
        <ul class="list-unstyled mobile-menu__pages">
            <li class="mobile-menu__category">
                ...
                <ul class="list-unstyled mobile-menu__submenu"><li class="mobile-menu__subitem first active"><a href="/index.php?id=7" class="mobile-menu__sublink link" >Межкомнатные двери</a></li>
...
<li class="mobile-menu__subitem last"><a href="/index.php?id=2" class="mobile-menu__sublink link" >Наши работы</a></li>
    ...
    <div class="content__menu affix-menu">
        <ul class="menu list-unstyled"><li class="menu__item first active"><a href="/index.php?id=7" class="link menu__link" title="Межкомнатные двери" >Межкомнатные двери</a><ul class="menu__submenu list-unstyled"><li class="menu__item first"><a href="/index.php?id=8" class="link menu__link" title="Классические" >Классика</a></li>
<li class="menu__item active"><a href="/index.php?id=9" class="link menu__link" title="Современные" >Современные</a></li>
...
<li class="menu__item last"><a href="/index.php?id=17" class="link menu__link" title="Наш салон" >Наш салон</a></li>
                ...
                <div class="content__main">
                    <ul class="crumbs list-inline"><li class="crumbs__item"><a class="crumbs__link" href="/">Главная</a></li>&gt;<li class="crumbs__item"><a class="crumbs__link" href="/index.php?id=7">Межкомнатные двери</a></li>&gt;<li class="crumbs__item">Современные</li></ul>
                    <h1 class="page-title">Современные</h1>
...
<script src="/assets/js/main.js"></script>
  ...
  array (
    '[[*pagetitle]]' => 'Современные',
    '[[*longtitle]]' => '',
    '[[*longtitle:is=``:then=`Современные`:else=``]]' => 'Современные',
    '[[*description]]' => '',
    '[[$head]]' => '<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<li class="menu__item last"><a href="/index.php?id=17" class="link menu__link" title="Наш салон" >Наш салон</a></li>
    ...
    '[[$crumbs]]' => '<ul class="crumbs list-inline"><li class="crumbs__item"><a class="crumbs__link" href="/">Главная</a></li>&gt;<li class="crumbs__item"><a class="crumbs__link" href="/index.php?id=7">Межкомнатные двери</a></li>&gt;<li class="crumbs__item">Современные</li></ul>',
    '[[getResources?
